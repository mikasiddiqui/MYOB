...
from sklearn.naive_bayes import MultinomialNB, GaussianNB, BernoulliNB #3 different algorithms
...
all_words = nltk.FreqDist(all_words) #converted

word_features = list(all_words.keys())[:9001] #top 9001 words from all words

#pickle word features
save_word_features = open("pickles/word_features_over9k.pickle","wb")
...
featuresets = [(find_features(rev), category) for (rev, category) in documents] #word containment
...
print("Classifier Orig: ", (nltk.classify.accuracy(classifier, testing_set))*100)

#pickle original classifier
save_classifier = open("pickles/orig_classifier.pickle","wb")
...
print("Bernoulli: ", (nltk.classify.accuracy(BernoulliNB_classifier, testing_set))*100)

#pickle BernoulliNB classifier
...
print("Logistic: ", (nltk.classify.accuracy(LogisticRegression_classifier, testing_set))*100)
...
print("SGDClassifier: ", (nltk.classify.accuracy(SGDClassifier_classifier, testing_set))*100)

#pickle SGDClassifier classifier
...
print("NuSVC: ", (nltk.classify.accuracy(NuSVC_classifier, testing_set))*100)
