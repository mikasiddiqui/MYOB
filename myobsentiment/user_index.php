...
//Task List
$sqltask = "SELECT * FROM completed ORDER BY deadline ASC LIMIT 2";
...
<link rel="shortcut icon" href="favicon.ico">
    ...
    <title>Cakebot Analyser - Giovanni</title>
      ...
      <div class="row row-offcanvas row-offcanvas-left">
         ...
         <div class="col-sm-3 col-md-2 sidebar-offcanvas" id="sidebar" role="navigation" style="background-color:#f5f5f5;">
            ...
            <ul class="nav nav-sidebar">
              <li class="active"><a href="user_index.php"><strong>Overview</strong></a></li>
        ...
        <div class="col-sm-9 col-md-10 main">
		  ...
		  <h1 class="page-header">
            Cakebot Analyser - Giovanni
          </h1>

          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder text-center">
              <a href="user_tasks.php"><span class="glyphicon glyphicon-pencil" style="font-size:50px" aria-hidden="true"></span></a>
              <h4>View Tasks</h4>

            </div>
            <div class="col-xs-6 col-sm-3 placeholder text-center">
              <a href="completed_tasks.php"><span class="glyphicon glyphicon-pencil" style="font-size:50px" aria-hidden="true"></span></a>
			<h4>All Completed Tasks</h4>

            </div>
			<div class="col-xs-6 col-sm-3 placeholder text-center">
              <a href="suggestions.php"><span class="glyphicon glyphicon-pencil" style="font-size:50px" aria-hidden="true"></span></a>
          ...
          <h2 class="sub-header">Latest Completed Tasks</h2>
