...
<div class="container-fluid">
      ...
      <div class="row row-offcanvas row-offcanvas-left">
         ...
         <div class="col-sm-3 col-md-2 sidebar-offcanvas" id="sidebar" role="navigation" style="background-color:#f5f5f5;">
            ...
            <ul class="nav nav-sidebar">
              <li class="active"><a href="suggestions.php"><strong>Comments/Suggestions</strong></a></li>
...
<input type="hidden" name="MAX_FILE_SIZE" >
            <table class="table table-bordered">
			  ...
			  <td class="col-md-10"><input type="text" class="form-control" name="title" id="title" placeholder="Enter Title" required></td>              
			  </tr>
                <tr>
